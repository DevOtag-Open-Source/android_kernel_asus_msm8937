...
#define paul(fmt, arg...) printk(KERN_ERR "[Paul][HXTP][%s][%d] "fmt"\n", __func__, __LINE__, ##arg)
// wangbing@wind-mobi.com 2018316 end   <<< [1/1] add the debug log

// wangbing@wind-mobi.com 20180423 begin >>> [4/7] add tp probe flag
extern int tp_is_probe;
// wangbing@wind-mobi.com 20180423 end   <<< [4/7] add tp probe flag
