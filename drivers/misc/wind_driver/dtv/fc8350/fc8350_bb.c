...
static s32 fc8350_set_acif_dvbt(HANDLE handle, DEVICEID devid, u32 clk)
{
	if (BBM_BAND_WIDTH_DVB == 6) {
		...
		switch (clk) {
		case 112000:
			bbm_byte_write(handle, devid, BBM_ACIF_COEF_00, 0x04);
			bbm_byte_write(handle, devid, BBM_ACIF_COEF_01, 0xfe);
			bbm_byte_write(handle, devid, BBM_ACIF_COEF_02, 0xfa);
			bbm_byte_write(handle, devid, BBM_ACIF_COEF_03, 0x00);
			bbm_byte_write(handle, devid, BBM_ACIF_COEF_04, 0x07);
			bbm_byte_write(handle, devid, BBM_ACIF_COEF_05, 0x04);
			bbm_byte_write(handle, devid, BBM_ACIF_COEF_06, 0xfa);
			bbm_byte_write(handle, devid, BBM_ACIF_COEF_07, 0xf7);
			bbm_byte_write(handle, devid, BBM_ACIF_COEF_08, 0x03);
			bbm_byte_write(handle, devid, BBM_ACIF_COEF_09, 0x0d);
			bbm_byte_write(handle, devid, BBM_ACIF_COEF_10, 0x05);
			bbm_byte_write(handle, devid, BBM_ACIF_COEF_11, 0xef);
			bbm_byte_write(handle, devid, BBM_ACIF_COEF_12, 0xed);
			bbm_byte_write(handle, devid, BBM_ACIF_COEF_13, 0x14);
			bbm_byte_write(handle, devid, BBM_ACIF_COEF_14, 0x4f);
			bbm_byte_write(handle, devid, BBM_ACIF_COEF_15, 0x6b);
			break;
		case 134400:
			bbm_byte_write(handle, devid, BBM_ACIF_COEF_00, 0x04);
			bbm_byte_write(handle, devid, BBM_ACIF_COEF_01, 0xff);
			bbm_byte_write(handle, devid, BBM_ACIF_COEF_02, 0xfa);
			bbm_byte_write(handle, devid, BBM_ACIF_COEF_03, 0xff);
			bbm_byte_write(handle, devid, BBM_ACIF_COEF_04, 0x06);
			bbm_byte_write(handle, devid, BBM_ACIF_COEF_05, 0x05);
			bbm_byte_write(handle, devid, BBM_ACIF_COEF_06, 0xfb);
			bbm_byte_write(handle, devid, BBM_ACIF_COEF_07, 0xf7);
			bbm_byte_write(handle, devid, BBM_ACIF_COEF_08, 0x01);
			bbm_byte_write(handle, devid, BBM_ACIF_COEF_09, 0x0d);
			bbm_byte_write(handle, devid, BBM_ACIF_COEF_10, 0x06);
			bbm_byte_write(handle, devid, BBM_ACIF_COEF_11, 0xef);
			bbm_byte_write(handle, devid, BBM_ACIF_COEF_12, 0xec);
			bbm_byte_write(handle, devid, BBM_ACIF_COEF_13, 0x13);
			bbm_byte_write(handle, devid, BBM_ACIF_COEF_14, 0x4f);
			bbm_byte_write(handle, devid, BBM_ACIF_COEF_15, 0x6c);
			break;
		case 110400:
			bbm_byte_write(handle, devid, BBM_ACIF_COEF_00, 0x03);
		...
		enum BROADCAST_TYPE broadcast, u32 freq)
{
	...
	div = new_clk / (BBM_XTAL_FREQ / 1000);
	for (pow = 0; pow < 3; pow++) {
		div = div * 2;
		if (((u32) div % 1000) == 0)
			break;
...
s32 fc8350_init(HANDLE handle, DEVICEID devid)
{
	...
	else bbm_byte_write(handle, DIV_MASTER, BBM_TS_SEL, 0x80);
#endif /* #ifdef BBM_I2C_TSIF */
	...
	bbm_byte_write(handle, DIV_BROADCAST, BBM_XTAL_GAIN, 0x00);
	bbm_byte_write(handle, DIV_BROADCAST, BBM_XTAL_LOAD_CAP, 0x05);
	bbm_byte_write(handle, DIV_BROADCAST, BBM_LDO_VCTRL, 0x07);
	bbm_byte_write(handle, DIV_BROADCAST, BBM_BB2XTAL_VCTRL, 0x0a);
	...
	else bbm_byte_write(handle, DIV_BROADCAST
