...
#define FC8350_FREQ_XTAL      BBM_XTAL_FREQ
...
static void fc8350_set_filter(HANDLE handle, DEVICEID devid, u16 filter_bw)
{
	...
	div_cal = (875000 / filter_bw) * FC8350_FREQ_XTAL / 10000;
...
static void fc8350_1seg_init(HANDLE handle, DEVICEID devid, u16 filter_bw)
{
	...
	fc8350_write(handle, devid, 0x2b, 0x10);
...
static s32 fc8350_tuner_set_pll(HANDLE handle, DEVICEID devid, u32 freq)
{
	...
	n_val =	f_vco / FC8350_FREQ_XTAL / ref_div;
	f_diff = f_vco - FC8350_FREQ_XTAL * n_val;

	f_diff_shifted = f_diff << (20 - pre_shift_bits);

	k_val = (f_diff_shifted / (FC8350_FREQ_XTAL >>
				(pre_shift_bits - 1))) << 1;
	k_val = k_val | 1;
		...
		enum BROADCAST_TYPE broadcast)
{
	...
	if (FC8350_FREQ_XTAL >= 32000)
		fc8350_write(handle, devid, 0x84, 0x1f);
	else
		fc8350_write(handle, devid, 0x84, (FC8350_FREQ_XTAL / 1000));
	...
	fc8350_write(handle, devid, 0x9b, 0x3c);
	fc8350_write(handle, devid, 0x9c, 0x3c);
